...
class WC_Admin_Meta_Boxes {
	...
	public function __construct() {
       ...
       // add_action( 'woocommerce_process_product_meta', 'WC_Meta_Box_addon_Product_Images::save', 20, 2 );
	...
	public function add_meta_boxes() {
        ...
        //add_meta_box( 'woocommerce-product-data', __( 'Product Gallery', 'woocommerce' ), 'WC_Meta_Box_addon_Product_Images::output', 'product', 'side', 'low' );
